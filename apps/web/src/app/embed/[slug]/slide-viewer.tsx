...
const BetterTStackCover = dynamic(() => import("@/app/better-t-stack/slides/cover"));
...
const BetterTStackBusiness = dynamic(() => import("@/app/better-t-stack/slides/business-content"));
const BetterTStackContent = dynamic(() => import("@/app/better-t-stack/slides/content"));
const BetterTStackBackCover = dynamic(() => import("@/app/better-t-stack/slides/back-cover"));

// react-three-fiber slides
const R3FCover = dynamic(() => import("@/app/react-three-fiber/slides/cover"));
const R3FSelfIntro = dynamic(() => import("@/app/react-three-fiber/slides/self-introduction"));
const R3FCorporate = dynamic(() => import("@/app/react-three-fiber/slides/corporate-philosophy"));
const R3FBusiness = dynamic(() => import("@/app/react-three-fiber/slides/business-content"));
const R3FBackCover = dynamic(() => import("@/app/react-three-fiber/slides/back-cover"));

// revealjs-slideDeck slides
const RevealCover = dynamic(() => import("@/app/revealjs-slideDeck/slides/cover"));
const RevealContent = dynamic(() => import("@/app/revealjs-slideDeck/slides/content"));

// tacotuesday slides
const TacoCover = dynamic(() => import("@/app/tacotuesday/slides/cover"));

// you-must-have-dotfiles slides
const DotfilesCover = dynamic(() => import("@/app/you-must-have-dotfiles/slides/cover"));
const DotfilesSlidesContent = dynamic(() => import("@/app/you-must-have-dotfiles/slides.mdx"));
